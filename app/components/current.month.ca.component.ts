...
export class CurrentMonthCaComponent{
  ...
  ngOnInit(){
    ...
    let filter = new Filter({type:"current_month&&contractor", dateBegin:"", dateEnd:"", state:"",profession:"",contractorId:depannologue_id})
